...
const Wool = ({number, rarity, color, onClick, selected, dimmed, votes, showLiveScore}) => {
    ...
    return (
        ...
        >
            ...
            />
            {votes !== null && showLiveScore && <p className={`${styles.votesCount}`}>{votes || 0}</p>}
        </div>
    )
}
